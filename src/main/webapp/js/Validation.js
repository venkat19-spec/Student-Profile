function validation(){
	...
	function checkInputs() {
		...
		if(passwordValue === '') {
			...
			setErrorFor(pass1, '*Password must be atleast 6 characters')
		} else {
			setSuccessFor(pass1);
		}
	...
	function isUserName(username) {
		return /^(CB\.EN\.U4CSE1[0-9][0-9][0-9][0-9]|CB\.EN\.U4ECE1[0-9][0-9][0-9][0-9]|CB\.EN\.U4MEC1[0-9][0-9][0-9][0-9]|CB\.EN\.U4EEE1[0-9][0-9][0-9][0-9]|CB\.EN\.U4CHE1[0-9][0-9][0-9][0-9]|CB\.EN\.U4AER1[0-9][0-9][0-9][0-9]|[1-9][1-9][1-9][1-9]|WA[1-10])$/.test(username);
	}
