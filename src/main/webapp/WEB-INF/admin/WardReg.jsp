...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!--========== CSS ==========-->
        <link rel="stylesheet" href="../css/WardenReg.css">
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                <div class="title">Sign Up - Warden</div>
                    <div class="content">
                        <form action="../admin/WardenRegistration" method="POST">
                            ...
                            <div class="user-details" id="form">
                                ...
                                <div class="input-box">
                                    <span class="details"><strong>Warden ID</strong></span>
                                    <input type="text" placeholder="Enter Username" id="username" name="username" required =""
                                    pattern="([W][A]\.[0-9][0-9][0-9][0-9])"
                                    oninvalid="this.setCustomValidity('Enter a valid warden ID')" oninput="setCustomValidity('')">
                                ...
                                <!--========== DROPDOWN SELECTION ==========-->
                                <div class="input-box">
                                    <span class="details"><strong>Block</strong></span>
                                    <select name="block" id= "blk" required>
